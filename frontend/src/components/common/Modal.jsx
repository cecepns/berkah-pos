...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      ...
      {/* Modal Dialog */}
      <div
        className={`relative w-full ${maxWidth} bg-white border border-slate-200 rounded-xl sm:rounded-2xl shadow-xl overflow-hidden z-10 my-2 sm:my-8 transition-all transform animate-in fade-in zoom-in-95 duration-200`}
        role="dialog"
        aria-modal="true"
      >
        {/* Header */}
        ...
        {/* Content Body */}
        <div className="p-3.5 sm:p-6 max-h-[calc(90vh-5rem)] overflow-y-auto text-slate-800">
          {children}
        </div>
      </div>
    </div>
